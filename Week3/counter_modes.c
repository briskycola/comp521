...
int main(int argc, char **argv)
{
    if (argc != 3)
    {
        fprintf(stderr, "usage: %s mutex|atomix THREADS\n", argv[0]);
        return 1;
    }
    ...
    if ((strcmp(mode, "mutex") != 0 && strcmp(mode, "atomic") != 0 || thread_count < 1 || thread_count > 64))
    {
        fprintf(stderr, "invalid code or thread count\n");
        return 1;
    }
